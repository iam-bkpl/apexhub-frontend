    ...
    return (
        <>
            <div className="col-xl-4 px-4">
                <div className="card pb-3 bg-white">
                    <div className="card-body profile-card pt-4 d-flex flex-column align-items-center ">

                        <img src="https://cdn.pixabay.com/photo/2015/07/09/00/29/woman-837156_1280.jpg" alt="Profile"
                            className="rounded-circle" style={{ height: "120px" }} />
                        <h2>Kevin Anders</h2>
                        <h3 className='mt-2'>Web Designer</h3>
                        {/* <div className="social-links mt-4">
                            <a href="#" className="twitter"><i className="fa-brands fa-twitter fs-2 "></i></a>
                            <a href="#" className="facebook"><i className="fa-brands fa-facebook fs-2"></i></a>
                            <a href="#" className="instagram"><i className="fa-brands fa-square-instagram fs-2"></i></a>
                            <a href="#" className="linkedin"><i className="fa-brands fa-linkedin fs-2"></i></a>
                        </div> */}
                    </div>
                </div>
                <div className="card mt-3 bg-white">

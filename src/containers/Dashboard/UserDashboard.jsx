        ...
        <div className="content nav-content">
          ...
          <div className="container-fluid pt-4 px-4">
            <div className="row g-4">
              <CardBig cardTitle="Total Users" number={totalUser} iconClass="fa fa-users fa-4x text-primary" />
              <CardBig cardTitle="Active Users" number={totalActiveUsers} iconClass="fa fa-user-plus fa-4x text-primary"  />
              <CardBig cardTitle="Blocked Users" number={totalInactiveUsers} iconClass="fa fa-user-lock fa-4x text-primary"  />
            </div>
          </div>
          <UserTable/>
